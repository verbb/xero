...
$(document).ready(function () {
  ...
  $("#order-actions .order-flex")
    .eq(0)
    .prepend('<a href="javascript:;" class="send-to-xero-btn submit btn">' + btnOriginalText + '</a><div class="spacer"></div>');
  ...
  if (!sentToXero) {
    $(".send-to-xero-btn").click(function () {
      ...
      if (orderId) {
        ...
        $.get(`/${Craft.cpTrigger}/sendordertoxero`, { orderId: orderId })
          .done(function (data) {
